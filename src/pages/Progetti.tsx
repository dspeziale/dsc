...
const Progetti = () => {
    ...
    const projects = [
        ...
        {
            title: 'GrowStack',
            description: 'Web dashboard per il monitoraggio e la gestione di piattaforme hardware con osservabilità di sistema in tempo reale.',
            category: 'Web',
            ...
            tags: ['Python', 'Dashboard', 'Vercel'],
            url: 'https://growstacks.vercel.app/',
        },
        {
            title: 'Core Flow',
            description: 'Piattaforma di integrazione e flusso di lavoro centralizzato per la gestione dei processi operativi.',
            category: 'Web',
            ...
            url: 'https://core-flow-dsc.vercel.app/',
        },
        {
            title: 'Agri 4.0',
            description: 'Modulo di reportistica geospaziale AI con visualizzazione di coperture satellitari ad alta precisione.',
            ...
            tags: ['AI', 'Geospatial', 'Satellite'],
            url: 'https://agri-four.vercel.app/',
        },
        {
            title: 'Impulse RAG',
